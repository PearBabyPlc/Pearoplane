...
// UPDATE ON BUG: seemingly fixed, but some other stuff persists - i think it's to do with
//                gimbal lock when using Euler angles. I've been suggested quaternions to help
...
// this does something permanently for some reason
